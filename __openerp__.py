...
{
    'name': 'Lions Eye & General Hospital',
    'version': '1.0.0',
...
membership products (schemes).
    ...
    'data': [
        ...
        'sample/report/report_external_layout.xml',
        ...
        'sample/report/report_amh.xml',
        'sample/report/report_hcg.xml',
        'sample/report/report_hlab27.xml',
        ...
        'admission/legh_admission_view.xml',
        'admission/legh_admission_activated_view.xml',
        'admission/legh_admission_released_view.xml',
        'admission/legh_admission_cancelled_view.xml',
        'admission/release/admission_release_view.xml',
        'admission/legh_emergency_view.xml',
        'admission/legh_emergency_activated_view.xml',
        'admission/legh_emergency_released_view.xml',
        ...
        'inventory/purchase_order_line_inherit_view.xml',
        ...
        'indoor_pharmacy/indoor_pharmacy_views.xml',
        'indoor_pharmacy/return_indoor_pharmacy_views.xml',
        'indoor_pharmacy/report/report_indoor_pos_order.xml',
        'indoor_pharmacy/report/report_indoor_pos_order_menu.xml',
    ],
    'demo': [],
    'installable': True,
    'auto_install': False,
